      ...
      <div className={`p-6 md:p-8 rounded-3xl border transition-all shadow-[0_8px_30px_rgb(0,0,0,0.04)] glass-panel ${isHighContrast
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-extrabold rounded-xl shrink-0 flex items-center justify-center gap-2 shadow-md transition-transform active:scale-95"
          >
