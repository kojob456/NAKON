      ...
      <div className={`p-6 md:p-8 rounded-3xl border transition-all shadow-[0_8px_30px_rgb(0,0,0,0.04)] glass-panel ${
        ...
        <div className="mt-5 p-4 rounded-2xl bg-blue-600/10 dark:bg-blue-900/30 border border-blue-500/20 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs leading-relaxed text-blue-950 dark:text-blue-200">
          <div className="flex items-start md:items-center gap-2.5">
            ...
            <span>
              <strong>สรุปสถานการณ์บริหารจัดการน้ำอ่างเก็บน้ำ (8 แหล่งสำคัญทั่วจังหวัด):</strong> ขณะนี้เขื่อนคลองดินแดงและเขื่อนห้วยน้ำใสมีความจุแตะเกณฑ์เกิน 90% ชลประทานได้ปรับเพิ่มอัตราการพร่องน้ำผ่านคลองสายหลัก ส่วนอ่างเก็บน้ำคลองกระทูน เสม็ดจวน คลองสังข์ กะปาง คลองตราย และคลองคุด ยังอยู่ในเกณฑ์ปลอดภัยสามารถรองรับมวลน้ำป่าจากเขาหลวงได้ดี
            </span>
          </div>
        </div>
      </div>
